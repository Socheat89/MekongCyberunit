              ...
              <form (ngSubmit)="enableTwoFactor()" class="pt-3 border-t border-slate-200 space-y-4">
                ...
                <div class="flex items-center space-x-3 pt-1">
                  <button
                    ...
                    class="flex-1 py-2.5 px-4 rounded-xl bg-white hover:bg-indigo-600 text-indigo-700 hover:text-white border-2 border-indigo-600 text-xs font-bold shadow-sm transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                  >
                    @if (isSubmitting()) {
